...
<script type="text/javascript">
	...
	function pdsCheck(f) { //포토갤러리 유효성 검사 //1) 이름이 2자 이상인가
...
if(passwd.length<4 || passwd.length>15){
	...
	if(filename.length==0){
		alert("첨부파일을 선택하세요.");
		return false; 
		}else{ //파일 타입 (확장자를 출력하시오) //마지막 . 의 순서 
		...
		if(ext=="png" || ext=="jpg" || ext=="gif"){
			return true; 
				...
				alert("이미지 파일만 가능합니다."); 
				return false; 
				}//if end }//if end return true; }//pdsCheck() end
		}
}
 ...
 <table class="table table-condensed">
  <tr> <th>성명</th> <td>
  <input type="text" name="wname" size="20" maxlength="100" required autofocus>
  </td> </tr> <tr> <th>제목</th> <td> 
  <textarea rows="5" cols="30" name="subject"></textarea> </td> </tr> 
  <tr> 
  <th>비밀번호</th> 
